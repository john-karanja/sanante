...
- Fixed portfolio pagination on front page

= 1.5.3 - 15-11-2023 =
- Improved Cross Site Scripting (XSS) vulnerability
- Added role permissions for install plugins during import

= 1.5.2 - 14-11-2023 =
- Fixed Cross Site Scripting (XSS) vulnerability
- Fixed Local File Inclusion vulnerability

= 1.5.1 - 21-09-2023 =
- Added compatibility for Qode Grid on Elementor Containers widget
