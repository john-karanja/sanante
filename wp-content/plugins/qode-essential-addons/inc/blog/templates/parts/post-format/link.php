...
if ( ! empty( $link_url ) ) {
	...
	<div class="qodef-e-link">
		...
		<<?php echo qode_essential_addons_framework_sanitize_tags( $quote_link_tag ); ?> class="qodef-e-link-text"><?php echo esc_html( $link_text ); ?></<?php echo qode_essential_addons_framework_sanitize_tags( $quote_link_tag ); ?>>
