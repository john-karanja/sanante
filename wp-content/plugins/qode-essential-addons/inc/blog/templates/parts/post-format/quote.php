...
if ( ! empty( $quote_text ) ) {
	...
	<div class="qodef-e-quote">
		...
		<?php } ?>
		<<?php echo qode_essential_addons_framework_sanitize_tags( $quote_link_tag ); ?> class="qodef-e-quote-text"><?php echo esc_html( $quote_text ); ?></<?php echo qode_essential_addons_framework_sanitize_tags( $quote_link_tag ); ?>>
		<?php if ( ! empty( $quote_author ) ) { ?>
			<<?php echo qode_essential_addons_framework_sanitize_tags( $author_title_tag ); ?> class="qodef-e-quote-author"><?php echo esc_html( $quote_author ); ?></<?php echo qode_essential_addons_framework_sanitize_tags( $author_title_tag ); ?>>
		<?php } ?>
		<?php if ( ! is_single() ) { ?>
