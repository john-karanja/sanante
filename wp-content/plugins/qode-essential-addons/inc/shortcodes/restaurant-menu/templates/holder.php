			...
			<div class="qodef-m-item qodef-e">
				<?php if ( ! empty( $item['item_title'] ) ) : ?>
					<div class="qodef-e-heading">
						<<?php echo qode_essential_addons_framework_sanitize_tags( $title_tag ); ?> class="qodef-e-heading-title" <?php qode_essential_addons_framework_inline_style( $this_shortcode->get_title_styles( $params ) ); ?>><?php echo wp_kses_post( $item['item_title'] ); ?></<?php echo qode_essential_addons_framework_sanitize_tags( $title_tag ); ?>>
